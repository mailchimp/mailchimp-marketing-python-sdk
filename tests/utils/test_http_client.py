...
from mailchimp_marketing.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    _should_retry,
...
from mailchimp_marketing.core.request_options import RequestOptions
...
@patch("mailchimp_marketing.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("mailchimp_marketing.core.http_client.asyncio.sleep", new_callable=AsyncMock)

...
class ListAutomationsResponse(UniversalBaseModel):
    """
    An array of objects, each representing an Automation workflow.
    """

    links: typing_extensions.Annotated[
        typing.Optional[typing.List[ListAutomationsResponseLinksItem]],
    ...
    automations: typing.Optional[typing.List[AutomationWorkflow]] = pydantic.Field(default=None)
    """
    An array of objects, each representing an Automation workflow.
    """

...
class ListVerifiedDomainsResponseDomainsItem(UniversalBaseModel):
    """
    ...
    status: typing.Optional[ListVerifiedDomainsResponseDomainsItemStatus] = pydantic.Field(default=None)
    """

...
class MailchimpClient:
    ...
    server_prefix : typing.Optional[str]
        Server URL variable for 'serverPrefix'. Defaults to 'us1'.
    ...
    def __init__(
        ...
        *,
        ...
        server_prefix: typing.Optional[str] = None,
        token: typing.Union[str, typing.Callable[[], str]],
        ...
        if server_prefix is not None:
            _server_prefix = server_prefix if server_prefix is not None else "us1"
            _environment_url_templates = {
                MailchimpClientEnvironment.DEFAULT: "https://{serverPrefix}.api.mailchimp.com",
            }
            _url_template = _environment_url_templates.get(environment, "https://{serverPrefix}.api.mailchimp.com")
            if base_url is None:
                base_url = _url_template.format(serverPrefix=_server_prefix)

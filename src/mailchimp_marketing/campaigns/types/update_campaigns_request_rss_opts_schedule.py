...
class UpdateCampaignsRequestRssOptsSchedule(UniversalBaseModel):
    """
    The schedule for sending the RSS Campaign.
    """

    daily_send: typing.Optional[UpdateCampaignsRequestRssOptsScheduleDailySend] = pydantic.Field(default=None)
    """
    ...
    weekly_send_day: typing.Optional[UpdateCampaignsRequestRssOptsScheduleWeeklySendDay] = pydantic.Field(default=None)
    """

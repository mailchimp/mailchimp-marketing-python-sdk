...
class CreateCampaignsRequestVariateSettings(UniversalBaseModel):
    """
    ...
    send_times: typing.Optional[typing.List[CreateCampaignsRequestVariateSettingsSendTimesItem]] = pydantic.Field(
        default=None
    )
    """
    ...
    winner_criteria: CreateCampaignsRequestVariateSettingsWinnerCriteria = pydantic.Field()
    """

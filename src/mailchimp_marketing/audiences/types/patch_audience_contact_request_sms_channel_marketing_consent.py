...
class PatchAudienceContactRequestSmsChannelMarketingConsent(UniversalBaseModel):
    """
    ...
    source: typing.Optional[PatchAudienceContactRequestSmsChannelMarketingConsentSource] = pydantic.Field(default=None)
    """
    The source from which the parent's entity was created.
    """

    status: typing.Optional[PatchAudienceContactRequestSmsChannelMarketingConsentStatus] = pydantic.Field(default=None)
    """

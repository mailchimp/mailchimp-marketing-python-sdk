...
class AudiencesContactSmsChannelEffectiveSubscriptionStatus(UniversalBaseModel):
    """
    ...
    value: typing.Optional[AudiencesContactSmsChannelEffectiveSubscriptionStatusValue] = None

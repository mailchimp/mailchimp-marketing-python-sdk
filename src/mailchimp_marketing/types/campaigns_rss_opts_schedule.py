...
class CampaignsRssOptsSchedule(UniversalBaseModel):
    """
    The schedule for sending the RSS Campaign.
    """

    daily_send: typing.Optional[CampaignsRssOptsScheduleDailySend] = pydantic.Field(default=None)
    """
    ...
    weekly_send_day: typing.Optional[CampaignsRssOptsScheduleWeeklySendDay] = pydantic.Field(default=None)
    """

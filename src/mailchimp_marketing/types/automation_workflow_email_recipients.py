...
class AutomationWorkflowEmailRecipients(UniversalBaseModel):
    """
    ...
    segment_opts: typing.Optional[AutomationWorkflowEmailRecipientsSegmentOpts] = pydantic.Field(default=None)
    """

...
class CampaignRssOptsSchedule(UniversalBaseModel):
    """
    The schedule for sending the RSS Campaign.
    """

    daily_send: typing.Optional[CampaignRssOptsScheduleDailySend] = pydantic.Field(default=None)
    """
    ...
    weekly_send_day: typing.Optional[CampaignRssOptsScheduleWeeklySendDay] = pydantic.Field(default=None)
    """

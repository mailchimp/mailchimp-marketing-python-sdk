...
class CampaignFeedback(UniversalBaseModel):
    """
    A specific feedback message from a specific campaign.
    """

    links: typing_extensions.Annotated[
        typing.Optional[typing.List[CampaignFeedbackLinksItem]],
    ...
    source: typing.Optional[CampaignFeedbackSource] = pydantic.Field(default=None)
    """

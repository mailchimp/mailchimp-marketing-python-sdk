...
class AudiencesContactSmsChannelMarketingConsent(UniversalBaseModel):
    """
    ...
    source: typing.Optional[AudiencesContactSmsChannelMarketingConsentSource] = pydantic.Field(default=None)
    """
    The source from which the parent's entity was created.
    """

    status: typing.Optional[AudiencesContactSmsChannelMarketingConsentStatus] = pydantic.Field(default=None)
    """

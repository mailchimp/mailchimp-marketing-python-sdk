...
class ListBatchWebhooksResponseLinksItem(UniversalBaseModel):
    """
    ...
    method: typing.Optional[ListBatchWebhooksResponseLinksItemMethod] = pydantic.Field(default=None)
    """

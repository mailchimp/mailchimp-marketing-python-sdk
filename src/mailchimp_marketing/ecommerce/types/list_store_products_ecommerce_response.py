...
class ListStoreProductsEcommerceResponse(UniversalBaseModel):
    """
    A collection of a store's products.
    """

    links: typing_extensions.Annotated[
        typing.Optional[typing.List[ListStoreProductsEcommerceResponseLinksItem]],
    ...
    products: typing.Optional[typing.List[ECommerceProduct]] = pydantic.Field(default=None)
    """

...
class CreateStoreEcommerceRequestAddress(UniversalBaseModel):
    """
    The store address.
    """
    ...
    latitude: typing.Optional[CreateStoreEcommerceRequestAddressLatitude] = pydantic.Field(default=None)
    """
    The latitude of the store location.
    """

    longitude: typing.Optional[CreateStoreEcommerceRequestAddressLongitude] = pydantic.Field(default=None)
    """

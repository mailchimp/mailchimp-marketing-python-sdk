...
class ListStoreCartsEcommerceResponse(UniversalBaseModel):
    """
    A collection of a store's carts.
    """

    links: typing_extensions.Annotated[
        typing.Optional[typing.List[ListStoreCartsEcommerceResponseLinksItem]],
    ...
    carts: typing.Optional[typing.List[ECommerceCart]] = pydantic.Field(default=None)
    """

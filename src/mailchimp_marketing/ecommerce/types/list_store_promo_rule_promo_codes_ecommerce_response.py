...
class ListStorePromoRulePromoCodesEcommerceResponse(UniversalBaseModel):
    """
    A collection of the store's promo codes.
    """

    links: typing_extensions.Annotated[
        typing.Optional[typing.List[ListStorePromoRulePromoCodesEcommerceResponseLinksItem]],
    ...
    promo_codes: typing.Optional[typing.List[ECommercePromoCode]] = pydantic.Field(default=None)
    """

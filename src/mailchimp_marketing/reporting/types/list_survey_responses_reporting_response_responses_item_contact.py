...
class ListSurveyResponsesReportingResponseResponsesItemContact(UniversalBaseModel):
    """
    ...
    status: typing.Optional[ListSurveyResponsesReportingResponseResponsesItemContactStatus] = pydantic.Field(
        default=None
    )
    """

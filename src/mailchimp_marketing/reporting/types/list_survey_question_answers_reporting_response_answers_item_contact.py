...
class ListSurveyQuestionAnswersReportingResponseAnswersItemContact(UniversalBaseModel):
    """
    ...
    status: typing.Optional[ListSurveyQuestionAnswersReportingResponseAnswersItemContactStatus] = pydantic.Field(
        default=None
    )
    """

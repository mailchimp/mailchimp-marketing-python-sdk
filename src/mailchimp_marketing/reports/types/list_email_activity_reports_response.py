...
class ListEmailActivityReportsResponse(UniversalBaseModel):
    """
    A list of member's subscriber activity in a specific campaign.
    """

    links: typing_extensions.Annotated[
        typing.Optional[typing.List[ListEmailActivityReportsResponseLinksItem]],
    ...
    emails: typing.Optional[typing.List[EmailActivity]] = pydantic.Field(default=None)
    """

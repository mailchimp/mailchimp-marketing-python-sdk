...
class ListAbuseReportsListsResponseLinksItem(UniversalBaseModel):
    """
    ...
    method: typing.Optional[ListAbuseReportsListsResponseLinksItemMethod] = pydantic.Field(default=None)
    """

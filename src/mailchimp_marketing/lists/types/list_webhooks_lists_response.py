...
class ListWebhooksListsResponse(UniversalBaseModel):
    """
    Manage webhooks for a specific list.
    """

    links: typing_extensions.Annotated[
        typing.Optional[typing.List[ListWebhooksListsResponseLinksItem]],
    ...
    webhooks: typing.Optional[typing.List[ListWebhooks]] = pydantic.Field(default=None)
    """

...
class ListFacebookAdsResponse(UniversalBaseModel):
    """
    Contains an array of facebook ads.
    """

    links: typing_extensions.Annotated[
        typing.Optional[typing.List[ListFacebookAdsResponseLinksItem]],
    ...
    facebook_ads: typing.Optional[typing.List[FacebookAds]] = None
